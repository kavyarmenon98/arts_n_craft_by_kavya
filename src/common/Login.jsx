  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      particles.forEach((p) => {
        ...
        // Gold/Amber color for particles
        ...
        >
          ...
          <div className="text-center mb-10">
            ...
            >
              ...
              <img src="/src/assets/logo2.png" alt="Logo" className="w-28 relative z-10 mx-auto drop-shadow-lg" />
            </motion.div>
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-7">
            ...
            <div className="pt-4">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-4 rounded-xl bg-gradient-to-r from-[var(--color-primary)] via-[#ff9f43] to-[#ff8c00] text-black font-extrabold text-base shadow-xl hover:shadow-[var(--color-primary)]/40 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed tracking-widest"
              >
